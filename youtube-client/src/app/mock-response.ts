  ...
  items: [
    {
      ...
      snippet: {
        ...
        description:
          ...
          '\n30 мая 2019 года бы релиз Angular 8 и я решил записать  по ' +
          'нему быстрый курс. В видео вы узнаете, как Angular работает, как его установить.\n' +
          'В результате урока я покажу создание Todo приложения ' +
          'с разными подходами. Разберем работу с сервером, ' +
          'сервисами, пайпами, коммуникацией между компонентами и немного RxJS\n\nИсходный код:\n' +
